defmodule LearnkzWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(LearnkzWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(LearnkzWeb.Gettext, "errors", msg, opts)
    # end
